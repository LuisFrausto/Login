...
public class Login extends JFrame {
    ...
    public Login() {
        ...
        Cerrar.setIcon(new ImageIcon("src/image/Tasha.png"));
        ...
        ImagenLogin.setIcon(new ImageIcon("src/image/Registro.png"));
        ...
        PasswordI.setIcon(new ImageIcon("src/image/Llave.png"));
        Panel.add(PasswordI, new AbsoluteConstraints(10, 330, -1, -1));

        Entrar.setIcon(new ImageIcon("src/image/Enter.png"));
        Entrar.setBorder(null);
        Entrar.setBorderPainted(false);
        Entrar.setContentAreaFilled(false);
        Entrar.setCursor(new Cursor(Cursor.HAND_CURSOR));
        Entrar.setRolloverIcon(new ImageIcon("src/image/Enter.png"));
        Entrar.setRolloverSelectedIcon(new ImageIcon("src/image/Enter.png"));
        Entrar.setSelectedIcon(new ImageIcon("src/image/Enter.png"));
